            ...
            <div class="col-lg-8">
                <div class="single-recent-blog-post">
                    <div class="thumb">
                        ...
                        <ul class="thumb-info">
                            <li><a href=" {{ asset('assets') }}/#"><i class="ti-user"></i>Admin</a></li>
                            <li><a href=" {{ asset('assets') }}/#"><i class="ti-notepad"></i>January
                                    12,2019</a></li>
                    ...
                    <div class="details mt-20">
                        ...
                        <a class="button" href=" {{ asset('assets') }}/#">Read More <i class="ti-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="single-recent-blog-post">
                    ...
                    <div class="details mt-20">
                        ...
                        <p>Over yielding doesn't so moved green saw meat hath fish he him from given yielding
                            ...
                            gathered dominion sixth. Creeping deep said can't called second. Air created seed
                            heaven sixth created living</p>
                        <a class="button" href=" {{ asset('assets') }}/#">Read More <i
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <nav class="blog-pagination justify-content-center d-flex">
                            <ul class="pagination">
                                <li class="page-item">
                                    <a href=" {{ asset('assets') }}/#" class="page-link" aria-label="Previous">
                                        <span aria-hidden="true">
                                            <i class="ti-angle-left"></i>
                                        </span>
                                    </a>
                                </li>
                                <li class="page-item active"><a href=" {{ asset('assets') }}/#"
                                        class="page-link">1</a></li>
                                <li class="page-item"><a href=" {{ asset('assets') }}/#" class="page-link">2</a>
                                </li>
                                <li class="page-item">
                                    <a href=" {{ asset('assets') }}/#" class="page-link" aria-label="Next">
                                        <span aria-hidden="true">
